...
const categoryCards = [
  {
    name: "Protein Powder",
    emoji: "🥛",
    desc: "Whey, casein & plant protein",
  ...
  },
  {
    name: "Creatine",
    emoji: "💪",
    desc: "Strength & power gains",
    color: "from-red-900/40 to-red-950/20",
  },
  {
    name: "Vitamins & Supplements",
    emoji: "💊",
    desc: "Daily health essentials",
      ...
      <section className="hero-bg relative overflow-hidden py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl leading-tight font-black tracking-tight text-foreground sm:text-6xl lg:text-7xl">
              FUEL YOUR
              <br />
              <span className="gradient-text">GAINS</span>
            </h1>
            <p className="mt-6 max-w-lg text-lg leading-relaxed text-muted-foreground">
              Science-backed nutrition for serious athletes. From protein
              powders to pre-workouts — everything you need to crush your goals.
            </p>
        ...
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          {categoryCards.map((cat) => (
            ...
            >
              ...
              <ArrowRight className="absolute right-4 bottom-4 h-4 w-4 text-primary opacity-0 transition-opacity group-hover:opacity-100" />
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-primary px-8 py-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-lg text-primary-foreground/80">
            Join thousands of athletes who trust IronFuel to fuel their
            training. New products added weekly.
          </p>
          <Link href="/products" className="mt-6 inline-block">
            <Button
              size="lg"
              className="bg-primary-foreground font-bold text-primary hover:bg-primary-foreground/90"
            >
              Shop All Products
            </Button>
          </Link>
